	...
	return (
		<div
			className={twJoin(
				...
				layout === 'grid' ? 'px-4 lg:w-1/2 lg:px-8' : 'px-4 lg:px-16',
			)}
			key={post.id}
		>
					...
					>
						{publication.isTeam && (
							<div className="mb-4 flex w-full flex-row items-center">
								<div className="blog-post-card-author-pic mr-2 block h-8 w-8 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
									<Image
								...
								<div className="blog-post-card-author-name text-lg font-medium text-slate-800 dark:text-slate-200">
									{post.author.name}
								</div>
							</div>
						)}
